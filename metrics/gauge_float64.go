...
// GetOrRegisterGaugeFloat64 returns an existing GaugeFloat64 or constructs and
// registers a new StandardGaugeFloat64.
...
// uses sync.Mutex to manage a single float64 value.
